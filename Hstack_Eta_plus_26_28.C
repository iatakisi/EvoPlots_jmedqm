...
root -l -b -q Hstack_Eta_plus_28_30.C\(\"rootfiles.txt\",\"JetMET/Run\ summary/Jet/Cleanedak4PFJetsCHS/CHEn_mediumPt_EndCap\"\)
...
void Hstack_Eta_plus_26_28()
{
////////////////////////////Frac_Eta_plus_2.6_2.8////////////////////////////////////////////
///////////////////////////High_Pt////////////////////////////////////////////
  ...
  TFile *f1 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_CHFracVSeta_highPt.root");
  f1->ls(); 
  TH1F * h1 = (TH1F*)f1->Get("h4");
  h1->SetFillColor(kRed);
  h1->SetFillStyle(3001);

  TFile *f2 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_NHFracVSeta_highPt.root");
  f2->ls(); 
  TH1F * h2 = (TH1F*)f2->Get("h4");
  h2->SetFillColor(kBlue);
  h2->SetFillStyle(3001);
  
  TFile *f3 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_PhFracVSeta_highPt.root");
  f3->ls(); 
  TH1F * h3 = (TH1F*)f3->Get("h4");
  h3->SetFillColor(kGreen);
  h3->SetFillStyle(3001);
  
  THStack *hs1 = new THStack("hs1","High_Pt Frac Eta plus 2.6-2.8");
...
//define_Era  
  ...
  legend->Draw();
  c1->SaveAs("Plots/Stack_High_Pt_Frac_Eta_plus_26-28.pdf");
  c1->SaveAs("Plots/Stack_High_Pt_Frac_Eta_plus_26-28.png");
///////////////////////////High_Pt////////////////////////////////////////////
///////////////////////////Medium_Pt////////////////////////////////////////////
  ...
  TFile *f4 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_CHFracVSeta_mediumPt.root");
  f4->ls(); 
  TH1F * h4 = (TH1F*)f4->Get("h4");
  h4->SetFillColor(kRed);
  h4->SetFillStyle(3001);

  TFile *f5 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_NHFracVSeta_mediumPt.root");
  f5->ls(); 
  TH1F * h5 = (TH1F*)f5->Get("h4");
  h5->SetFillColor(kBlue);
  h5->SetFillStyle(3001);
  
  TFile *f6 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_PhFracVSeta_mediumPt.root");
  f6->ls(); 
  TH1F * h6 = (TH1F*)f6->Get("h4");
  h6->SetFillColor(kGreen);
  h6->SetFillStyle(3001);
  
  THStack *hs2 = new THStack("hs2","Medium_Pt Frac Eta plus 2.6-2.8");
...
//define_Era  
  ...
  legend->Draw();
  c2->SaveAs("Plots/Stack_Medium_Pt_Frac_Eta_plus_26-28.pdf");
  c2->SaveAs("Plots/Stack_Medium_Pt_Frac_Eta_plus_26-28.png");
...
///////////////////////////Low_Pt////////////////////////////////////////////
  ...
  TFile *f7 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_CHFracVSeta_lowPt.root");
  f7->ls(); 
  TH1F * h7 = (TH1F*)f7->Get("h4");
  h7->SetFillColor(kRed);
  h7->SetFillStyle(3001);

  TFile *f8 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_NHFacVSeta_lowPt.root");
  f8->ls(); 
  TH1F * h8 = (TH1F*)f8->Get("h4");
  h8->SetFillColor(kBlue);
  h8->SetFillStyle(3001);

  TFile *f9 = new TFile("Plots/bin79_Jet_Cleanedak4PFJetsCHS_PhFracVSeta_lowPt.root");
  f9->ls(); 
  TH1F * h9 = (TH1F*)f9->Get("h4");
  h9->SetFillColor(kGreen);
  h9->SetFillStyle(3001);
  
  THStack *hs3 = new THStack("hs3","Low_Pt Frac Eta plus 2.6-2.8");
...
//define_Era  
  ...
  legend->Draw();
  c3->SaveAs("Plots/Stack_Low_Pt_Frac_Eta_plus_26-28.pdf");
  c3->SaveAs("Plots/Stack_Low_Pt_Frac_Eta_plus_26-28.png");
///////////////////////////Low_Pt////////////////////////////////////////////
////////////////////////////Frac_Eta_plus_2.6-2.8////////////////////////////////////////////
